module.exports = function(Blockly) {
  ...
  Blockly.Blocks["sdcard_begin"] = {
    init: function() {
      this.appendDummyInput()
        .appendField(new Blockly.FieldImage("/static/icons/1137754.svg",20,20,"*"))
  ...
  Blockly.Blocks['sdcard_write_txt'] = {
    init: function() {
      this.appendDummyInput()
          .appendField(new Blockly.FieldImage("/static/icons/1137707.svg", 20, 20, "*"))
  ...
  Blockly.Blocks['sdcard_write_csv'] = {
    init: function() {
      this.appendDummyInput()
          .appendField(new Blockly.FieldImage("/static/icons/1137756.svg", 20, 20, "*"))
